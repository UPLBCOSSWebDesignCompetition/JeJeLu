...
import { SparklesCore } from "./ui/sparklesEffect.tsx";
  ...
  return (
    <div className="h-[20rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="w-[90rem] h-40 relative">
        ...
        <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-gold-500 to-transparent h-[5px] w-1/4 blur-sm" />
        <div className="absolute inset-x-60 top-0 bg-gradient-to-r from-transparent via-gold-500 to-transparent h-px w-1/4" />
